...
(function($)
{
	...
	{
		width			: 500,					// set width - best to match image width
		height			: 500,					// set height - best to match image height
	...
	ScratchPad.prototype = 
	{
		generate: function()
		{
			...
			.append(
				$(this.canvas)
				.attr('width', this.settings.width + 'em')
				.attr('height', this.settings.height + 'em')
			)
